...
var Baseline = (function () {
    ...
    Baseline.prototype.run = function (callback) {
        ...
        Results.load(this.baselinePath, function (err, baseline) {
            if (err)
                return callback(err);
            if (_this.updateBaseline) {
                baseline = undefined;
            }
            var updateBaseline = !baseline && _this.baselinePath;
            var timePerTest = _this.maxTime || (updateBaseline ? 30 : 2);
